/// <mls fileReference="_102053_/l2/demo1/acao-visualizacao.ts" enhancement="_102020_/l2/enhancementAura"/>
...
@customElement('demo1--acao-visualizacao-102053')
      ...
      <div class="page">
        <div class="shell">
          <header class="head">
            ...
            <h1 class="title">Ação & Visualização — originais (102040)</h1>
